...
classifier = cv2.CascadeClassifier('C:/Users/Lenovo/Desktop/face_detectionn/face_detectionn/haarcascade_frontalface_default.xml')

model = load_model("finalmodel (3).h5")

URL = 'http://192.168.29.90:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["laxmi","Gayatree","chottu"]
    return labels[pred]
